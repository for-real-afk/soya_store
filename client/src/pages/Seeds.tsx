                  ...
                  <div className="space-y-2 pt-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleSubcategoryChange('organic', checked as boolean)
                        }
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleSubcategoryChange('non-gmo', checked as boolean)
                        }
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          handleSubcategoryChange('heirloom', checked as boolean)
                        }
                      />
